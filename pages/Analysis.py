...
class Analysis():
    ...
    def page(self):
        ...
        def plot_business_type_pie_overall(df, spec_bus_type):
            ...
            text_format = "<div style='text-align:center; font-size: 20px;'> Current Businesses of type <strong style='color:blue'>{}</strong> accounts for <strong style='color:red'>{per:.3f}%</strong> in LA Area"
        ...
        def zipcode_filter(zipcode_list,zip_race_df):
            ...
            overall_max=index[0]
            str1="""<div style='text-align:left; font-size: 24px;'> This Bar plot shows zipcode <strong style='color:blue'>{zip1}</strong>,<strong style='color:blue'>{zip2}</strong>,<strong style='color:blue'>{zip3}</strong>, has a greater proportion of Race <strong style='color: orange'> {overall_max}</strong>. 
            There are more <strong style='color: orange'> {race1}</strong> in <strong style='color:blue'>{max1}</strong> which is <strong style='color:red'>{p1}%</strong>,more <strong style='color: orange'> {race2}</strong> in <strong style='color:blue'>{max2}</strong> which is <strong style='color:red'>{p2}%</strong> ,more <strong style='color: orange'> {race3}</strong> in <strong style='color:blue'>{max3}</strong> which is <strong style='color:red'>{p3}%</strong>.</div>""".format(
                zip1=zipcode_list[0],
                zip2 = zipcode_list[1],
                zip3 = zipcode_list[2],
