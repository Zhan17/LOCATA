...
class Analysis():
    ...
    def page(self):
        ...
        def plot_business_type_pie_overall(df, spec_bus_type):
            ...
            text_format = "<div style='text-align:left; font-size: 20px;'> Current Businesses of type <strong style='color:blue'>{}</strong> accounts for <strong style='color:red'>{per:.3f}%</strong> in LA Area"
